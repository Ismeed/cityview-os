    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/services/cng-conversion", changefreq: "monthly", priority: "0.9" },
          { path: "/why-cng", changefreq: "monthly", priority: "0.8" },
          { path: "/hire-purchase", changefreq: "monthly", priority: "0.9" },
