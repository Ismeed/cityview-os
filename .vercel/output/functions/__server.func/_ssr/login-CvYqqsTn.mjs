...
import { I as Mail, Ot as ArrowRight, R as Lock, c as UserCheck, x as Shield, xt as Building2 } from "../_libs/lucide-react.mjs";
import { t as ERPStore } from "./mockData-BCTNDn8F.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { t as Logo } from "./logo-CvAI6anB.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-CvYqqsTn.js
...
function LoginPage() {
	...
	const handleLogin = (e) => {
		...
		setLoading(true);
		setTimeout(() => {
			const user = ERPStore.getUsers().find((u) => u.email.toLowerCase() === email.toLowerCase() && u.passwordHash === password);
			if (user) {
				if (user.disabled) {
					toast.error("Access Suspended", { description: "This account has been disabled by the system administrator." });
					setLoading(false);
					return;
				}
	...
	const selectDemoAccount = (user) => {
		if (user.disabled) {
			toast.error("Access Suspended", { description: "This account has been disabled." });
			return;
		}
		setEmail(user.email);
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: ERPStore.getUsers().filter((u) => u.role === "Super Admin").map((user) => {
