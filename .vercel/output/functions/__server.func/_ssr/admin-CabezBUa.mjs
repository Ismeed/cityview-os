...
import { $ as ClipboardList, C as Search, D as Play, E as Plus, G as FileDown, H as Fuel, I as LayoutDashboard, J as Database, N as LogOut, O as Phone, Q as Clock, R as Info, T as RefreshCw, U as FileText, W as FilePenLine, _ as Shield, at as ChevronDown, b as Settings, c as UserCheck, d as TriangleAlert, dt as Calculator, et as CircleCheck, f as TrendingUp, ft as Building2, g as Sparkles, gt as Barcode, h as SquareUserRound, ht as Bell, i as Users, it as ChevronLeft, j as MapPin, l as Upload, lt as Calendar, mt as Boxes, n as Wrench, nt as CircleAlert, o as User, ot as Check, p as TrendingDown, q as DollarSign, r as Wallet, rt as ChevronRight, s as UserPlus, tt as CircleCheckBig, u as Truck, ut as CalendarDays, v as ShieldCheck, w as Save, x as Settings2, y as ShieldAlert, yt as ArrowRight } from "../_libs/lucide-react.mjs";
import { t as ERPStore } from "./mockData-GGYQI-9Q.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-CabezBUa.js
...
function Header({ selectedBranch, setSelectedBranch, selectedRole, setSelectedRole, currentUser, onLogout }) {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: isSuperOrAdmin ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: "flex items-center gap-2 rounded-2xl border border-border bg-white/50 px-4 py-2 text-xs font-semibold text-charcoal/80 select-none",
...
function ShiftManagement({ selectedBranch = "ALL" }) {
	const activeBranchName = {
		"BR-KT": "Katsina HQ",
		"BR-GB": "Gombe Hub"
	}[selectedBranch];
	...
	const availableVehicles = vehicles.filter((v) => v.status === "Available" && (activeBranchName ? v.branch === activeBranchName : true));
	const activeShiftDriverIds = shifts.filter((s) => s.status === "In Progress").map((s) => s.driverId);
	const availableDrivers = drivers.filter((d) => d.status === "Active" && !activeShiftDriverIds.includes(d.id) && (activeBranchName ? d.branch === activeBranchName : true));
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
							...
							className: "divide-y divide-border/60",
							children: shifts.filter((s) => activeBranchName ? s.branch === activeBranchName : true).map((shift) => {
...
function HirePurchase({ selectedBranch = "ALL" }) {
	...
	const filtered = contracts.filter((c) => {
		const driver = ERPStore.getDrivers().find((d) => d.id === c.driverId);
		const matchesSearch = c.id.toLowerCase().includes(search.toLowerCase()) || driver && driver.name.toLowerCase().includes(search.toLowerCase());
...
function AdminPanel() {
	...
	const renderTabContent = () => {
		...
		switch (activeTab) {
			...
			case "shifts": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShiftManagement, { selectedBranch });
