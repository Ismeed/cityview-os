...
import { $ as DollarSign, C as Search, D as Phone, E as Plus, G as Fuel, J as FilePenLine, K as FileText, L as LayoutDashboard, M as MapPin, O as Moon, P as LogOut, Q as EyeOff, R as Key, S as Send, St as Barcode, T as RefreshCw, Tt as ArrowRight, V as History, W as Funnel, Y as FileDown, Z as Eye, _ as Sparkles, _t as Calculator, at as Clipboard, b as ShieldAlert, bt as Boxes, c as UserCheck, ct as CircleCheckBig, d as TriangleAlert, dt as ChevronLeft, et as Database, f as TrendingUp, ft as ChevronDown, g as SquareUserRound, gt as Calendar, h as Sun, i as Users, it as Clock, j as Menu, k as MonitorSmartphone, l as Upload, lt as CircleAlert, n as Wrench, o as User, ot as ClipboardList, p as TrendingDown, pt as Check, q as FileSpreadsheet, r as Wallet, s as UserPlus, st as CircleCheck, t as X, u as Truck, ut as ChevronRight, v as Shield, vt as Building2, w as Save, x as Settings, xt as Bell, y as ShieldCheck, z as Info } from "../_libs/lucide-react.mjs";
import { t as useTheme } from "./useTheme-DsmUlAKc.mjs";
import { t as ERPStore } from "./mockData-Cs-rEA1t.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-CK2uQ8Fm.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					className: "text-sm text-muted-foreground mt-1",
					children: isAdmin ? "Manage system-wide corporate settings, download backups, and audit simulated user credentials." : "Update your login password and review your active branch operational privileges."
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
						className: "font-display font-bold text-lg text-foreground flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shield, { className: "h-5 w-5 text-emerald" }), "Enterprise Credentials Dashboard"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs text-muted-foreground mt-0.5",
						children: "Secure access directory listing login emails and passwords for walk-in simulation testing."
					})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "rounded-full bg-emerald-500/10 text-emerald px-3 py-1 text-xs font-bold w-fit",
						children: [ERPStore.getUsers().length, " Registered Accounts"]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
									className: "p-4 text-center",
									children: "Simulate Credentials"
								})
							] })
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", {
							className: "divide-y divide-border/60",
							children: ERPStore.getUsers().map((user) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
