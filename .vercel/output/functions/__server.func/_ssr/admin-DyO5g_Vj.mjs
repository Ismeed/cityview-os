...
import { $ as CircleCheck, C as Search, D as Play, E as Plus, F as LayoutDashboard, H as FileText, K as DollarSign, L as Info, N as LogOut, O as Phone, Q as ClipboardList, T as RefreshCw, U as FilePenLine, V as Fuel, W as FileDown, Z as Clock, _ as Shield, at as Check, b as Settings, c as UserCheck, ct as Calendar, d as TriangleAlert, dt as Building2, et as CircleCheckBig, f as TrendingUp, g as Sparkles, h as SquareUserRound, ht as Barcode, i as Users, it as ChevronDown, j as MapPin, l as Upload, lt as CalendarDays, mt as Bell, n as Wrench, nt as ChevronRight, o as User, p as TrendingDown, pt as Boxes, q as Database, r as Wallet, rt as ChevronLeft, s as UserPlus, tt as CircleAlert, u as Truck, ut as Calculator, v as ShieldCheck, vt as ArrowRight, w as Save, x as Settings2, y as ShieldAlert } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-DyO5g_Vj.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function Sidebar({ activeTab, setActiveTab, selectedRole }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
		className: `relative flex flex-col border-r border-border bg-charcoal text-white transition-all duration-300 ${collapsed ? "w-20" : "w-72"}`,
		children: [
...
var initialEmployees = [
	...
	},
	{
		...
		email: "mustapha.i@cityviewcng.com",
		role: "Branch Manager",
	...
	},
	{
		id: "EMP-07",
		name: "Fatima Umar",
		email: "fatima.u@cityviewcng.com",
		role: "Accountant",
		department: "Finance",
		branch: "Katsina HQ",
		salary: 35e4,
	...
	},
	{
		id: "EMP-10",
		name: "Zainab Yusuf",
		email: "zainab.y@cityviewcng.com",
...
var initialDrivers = [
	...
	},
	{
		...
		name: "Aliyu Katsina",
		phone: "08149887755",
		license: "NGA-KT-12431",
		guarantorName: "Alhaji Ibrahim",
		guarantorPhone: "08022221111",
		branch: "Katsina HQ",
		status: "Active",
		remittanceRate: 12e3
	},
	...
	},
	{
		...
		name: "Shehu Shagari",
		phone: "09033332211",
		license: "NGA-GB-44211",
		guarantorName: "Abubakar Shehu",
		guarantorPhone: "08055554444",
		branch: "Gombe Hub",
		status: "Active",
		remittanceRate: 12e3
	},
	{
		...
		name: "Garba Haruna",
		phone: "08169998822",
		license: "NGA-KT-77881",
		guarantorName: "Isah Haruna",
		guarantorPhone: "08033334444",
		branch: "Katsina HQ",
...
var initialVehicles = [
	...
	{
		id: "VEH-Car-01",
		plateNumber: "GB-102-Y02",
		type: "Car",
		fuelType: "Petrol",
		conversionStatus: "Petrol Only",
		branch: "Gombe Hub",
		status: "Available",
...
var initialShifts = [
	...
	},
	{
		...
		endMileage: 14310,
		expectedRemittance: 12e3,
		actualRemittance: 1e4,
		status: "Defaulted",
		notes: "Short of 2000 Naira due to engine diagnostic delay",
		date: "2026-07-04"
	}
];
...
var initialJobCards = [{
	id: "JB-1001",
	customerName: "Garba Musa",
	customerPhone: "08091112223",
	vehiclePlate: "KT-124-AAA",
	vehicleModel: "Toyota Corolla 2012",
	issueDescription: "Idle vibration and check engine light on.",
	...
	id: "JB-1002",
	customerName: "Salisu Bello",
	customerPhone: "07032223334",
	vehiclePlate: "GB-981-TRC",
	vehicleModel: "Tricycle (TVS King)",
	issueDescription: "Brake pads completely worn, clutch cable stiff.",
	assignedTechnicianId: "EMP-06",
	laborCharges: 3500,
	partsUsed: [{
		partId: "INV-BRK",
		name: "Premium Brake Pads (Keke)",
		quantity: 2,
		cost: 5e3
	}],
	status: "Completed",
...
var initialConversions = [{
	id: "CNG-2001",
	customerName: "Katsina State Ministry of Transport",
	vehiclePlate: "KT-100-MTR",
	vehicleModel: "Toyota Hiace Bus 2018",
	cngKitType: "Sequential 4-Cylinder Kit",
	cylinderSize: "90L Steel Cylinder",
	cost: 95e4,
	status: "Installation",
	assignedEngineers: ["Engr. Yusuf Bello", "Chidi Nwachukwu"],
	dateStarted: "2026-07-03"
}, {
	id: "CNG-2002",
	customerName: "Mallam Lawan",
	vehiclePlate: "GB-800-LAW",
	vehicleModel: "Suzuki Every Mini Bus",
	cngKitType: "Direct Injection Kit",
	cylinderSize: "60L Lightweight Composites",
	cost: 75e4,
	status: "Inspection",
	assignedEngineers: ["Bala Mohammed"],
	dateStarted: "2026-07-05"
}];
var initialInventory = [
	{
		id: "INV-KIT-4",
		name: "CNG Sequential Kit 4-Cylinder",
		category: "CNG Kits",
		stockLevel: 28,
		minStockLevel: 5,
		unitPrice: 22e4,
		supplier: "GasTech Italy Imports"
	},
	{
		id: "INV-KIT-6",
		name: "CNG Sequential Kit 6-Cylinder",
		category: "CNG Kits",
		stockLevel: 14,
		minStockLevel: 3,
		unitPrice: 34e4,
	...
	{
		id: "INV-CYL-60",
		name: "60L Seamless Steel CNG Cylinder",
		category: "Cylinders",
		stockLevel: 32,
		minStockLevel: 8,
		unitPrice: 15e4,
		supplier: "SinoCylinder Corp"
	},
	{
		id: "INV-CYL-90",
		name: "90L Seamless Steel CNG Cylinder",
		category: "Cylinders",
		stockLevel: 4,
		minStockLevel: 6,
		unitPrice: 19e4,
	...
	},
	{
		...
		minStockLevel: 10,
		unitPrice: 2500,
		supplier: "TVS Parts Lagos"
	},
	{
		id: "INV-TYR",
		name: "Heavy Duty Tricycle Tyre 4.00-8",
		category: "Tyres",
		stockLevel: 3,
		minStockLevel: 8,
		unitPrice: 18e3,
...
var initialTransactions = [
	{
		...
		description: "Deposit from Ministry of Transport (Toyota Hiace KT-100-MTR)",
		branch: "Katsina HQ",
		date: "2026-07-03"
	},
	{
		...
		description: "Musa Ibrahim daily HP repayment (VEH-Keke-01)",
		branch: "Katsina HQ",
		date: "2026-07-04"
	},
	{
		...
		amount: 12e3,
		category: "Hire Purchase",
		description: "Aliyu Katsina daily HP repayment (VEH-Keke-02)",
		branch: "Katsina HQ",
		date: "2026-07-04"
	},
	{
		...
		amount: 12e3,
		category: "Hire Purchase",
		description: "Usman Gombe daily HP repayment (VEH-Keke-03)",
		branch: "Gombe Hub",
		date: "2026-07-04"
	},
	{
		...
		type: "Revenue",
		amount: 1e4,
		category: "Fleet Remittance",
		description: "Shehu Shagari daily remittance (VEH-Keke-04) - Defaulted 2000",
		branch: "Gombe Hub",
		date: "2026-07-04"
	},
	{
		...
		description: "Job card invoice payment (JB-1002 Salisu Bello)",
		branch: "Gombe Hub",
		date: "2026-07-04"
	},
	{
		...
		description: "Payment to TVS Parts Lagos (Brake pads & tyres stock restock)",
		branch: "Katsina HQ",
		date: "2026-07-02"
	},
	{
		...
		description: "Electricity & generator diesel fueling (Gombe hub)",
		branch: "Gombe Hub",
		date: "2026-07-03"
	},
	{
		...
		amount: 2e4,
		category: "Fuel",
		description: "Refueling support vehicle (KT-HQ Patrol Toyota)",
		branch: "Katsina HQ",
		date: "2026-07-04"
	}
];
var initialAuditLogs = [
	{
		id: "LOG-1001",
		timestamp: "2026-07-05 07:30",
		user: "Mustapha Ibrahim",
		role: "Branch Manager",
		action: "Shift Start Check-out",
		details: "Checked out VEH-Keke-01 to Musa Ibrahim at Katsina HQ. Start mileage: 12,450."
	},
	{
		id: "LOG-1002",
		...
		role: "Cashier",
		action: "Shift Start Check-out",
		details: "Checked out VEH-Keke-03 to Usman Gombe at Gombe Hub. Start mileage: 8,900."
	},
	{
		id: "LOG-1003",
		...
		details: "Logged repair ticket JB-1001 for vehicle KT-124-AAA. Designated tech: Chidi Nwachukwu."
	},
	{
		id: "LOG-1004",
		timestamp: "2026-07-05 11:30",
		user: "Aminu Dangote",
		role: "Inventory Officer",
		action: "Log Stock Out",
		details: "Issued 1 Set of Spark Plugs & 1 Can Mobil 5W-30 Oil for repair ticket JB-1001."
	}
];
...
var ERPStore = class ERPStore {
	static getBranches = () => loadLocalStorageData("cityview_erp_branches", initialBranches);
	static saveBranches = (data) => saveLocalStorageData("cityview_erp_branches", data);
	static getEmployees = () => loadLocalStorageData("cityview_erp_employees", initialEmployees);
	static saveEmployees = (data) => saveLocalStorageData("cityview_erp_employees", data);
	static getDrivers = () => loadLocalStorageData("cityview_erp_drivers", initialDrivers);
	static saveDrivers = (data) => saveLocalStorageData("cityview_erp_drivers", data);
	static getVehicles = () => loadLocalStorageData("cityview_erp_vehicles", initialVehicles);
	static saveVehicles = (data) => saveLocalStorageData("cityview_erp_vehicles", data);
	static getShifts = () => loadLocalStorageData("cityview_erp_shifts", initialShifts);
	static saveShifts = (data) => saveLocalStorageData("cityview_erp_shifts", data);
	static getHPContracts = () => loadLocalStorageData("cityview_erp_hp_contracts", initialHPContracts);
	static saveHPContracts = (data) => saveLocalStorageData("cityview_erp_hp_contracts", data);
	static getJobCards = () => loadLocalStorageData("cityview_erp_job_cards", initialJobCards);
	static saveJobCards = (data) => saveLocalStorageData("cityview_erp_job_cards", data);
	static getConversions = () => loadLocalStorageData("cityview_erp_conversions", initialConversions);
	static saveConversions = (data) => saveLocalStorageData("cityview_erp_conversions", data);
	static getInventory = () => loadLocalStorageData("cityview_erp_inventory", initialInventory);
	static saveInventory = (data) => saveLocalStorageData("cityview_erp_inventory", data);
	static getTransactions = () => loadLocalStorageData("cityview_erp_transactions", initialTransactions);
	static saveTransactions = (data) => saveLocalStorageData("cityview_erp_transactions", data);
	static getAuditLogs = () => loadLocalStorageData("cityview_erp_audit_logs", initialAuditLogs);
	static saveAuditLogs = (data) => saveLocalStorageData("cityview_erp_audit_logs", data);
...
function Header({ selectedBranch, setSelectedBranch, selectedRole, setSelectedRole, onLogout }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: "sticky top-0 z-40 flex h-20 w-full items-center justify-between border-b border-border bg-white px-8 shadow-soft",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "hidden items-center gap-2 rounded-2xl bg-mist/60 px-4 py-2 text-xs font-semibold text-charcoal md:flex",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "h-4 w-4 text-forest" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Katsina/Lagos: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "font-mono text-forest-deep",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: "absolute right-0 mt-2 w-56 rounded-2xl border border-border bg-white p-2 shadow-elevated animate-fade-down z-50",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shield, { className: "h-4 w-4 text-forest" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Role: ", selectedRole] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "h-3 w-3 text-forest" })
						]
					}), showRoleSelector && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "absolute right-0 mt-2 w-64 max-h-80 overflow-y-auto rounded-2xl border border-border bg-white p-2 shadow-elevated animate-fade-down z-50",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "block px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-muted-foreground border-b border-border/60 mb-1",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: "absolute right-0 mt-2 w-80 rounded-3xl border border-border bg-white p-4 shadow-elevated animate-fade-down z-50",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function DriverManagement() {
	...
	const filtered = drivers.filter((d) => d.name.toLowerCase().includes(search.toLowerCase()) || d.id.toLowerCase().includes(search.toLowerCase()) || d.phone.includes(search));
	const rawContracts = ERPStore.getHPContracts();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-6 animate-fade-in",
		children: [
...
function ShiftManagement() {
	const [shifts, setShifts] = (0, import_react.useState)(ERPStore.getShifts());
	const [vehicles, setVehicles] = (0, import_react.useState)(ERPStore.getVehicles());
	const [drivers, setDrivers] = (0, import_react.useState)(ERPStore.getDrivers());
	const [showCheckout, setShowCheckout] = (0, import_react.useState)(false);
	const [checkoutData, setCheckoutData] = (0, import_react.useState)({
		driverId: "",
		vehicleId: "",
		startMileage: 0,
		startTime: "07:30",
	...
	const [activeCheckinShift, setActiveCheckinShift] = (0, import_react.useState)(null);
	const [checkinData, setCheckinData] = (0, import_react.useState)({
		endMileage: 0,
		endTime: "18:00",
		actualRemittance: 12e3,
		notes: ""
	...
	const handleStartShift = (e) => {
		...
		const updatedShifts = [{
			...
			expectedRemittance: driver?.remittanceRate || 12e3,
			status: "In Progress",
			date: (/* @__PURE__ */ new Date()).toISOString().split("T")[0]
		}, ...shifts];
		setShifts(updatedShifts);
		ERPStore.saveShifts(updatedShifts);
		const updatedVehicles = vehicles.map((v) => v.id === checkoutData.vehicleId ? {
			...v,
			status: "On Road",
			assignedDriverId: checkoutData.driverId
		} : v);
		setVehicles(updatedVehicles);
		ERPStore.saveVehicles(updatedVehicles);
		ERPStore.addAuditLog("Dispatcher", "Fleet Manager", "Shift Checkout", `Dispatched vehicle ${vehicle?.plateNumber} to driver ${driver?.name}. Start mileage: ${checkoutData.startMileage}.`);
		toast.success("Shift Started Successfully", { description: `${driver?.name} is on the road with vehicle ${vehicle?.plateNumber}.` });
		setCheckoutData({
			driverId: "",
			vehicleId: "",
			startMileage: 0,
	...
	const handleEndShiftSubmit = (e) => {
		e.preventDefault();
		if (!activeCheckinShift) return;
		const finalStatus = checkinData.actualRemittance < activeCheckinShift.expectedRemittance ? "Defaulted" : "Completed";
		const updatedShifts = shifts.map((s) => {
			if (s.id === activeCheckinShift.id) return {
				...s,
		...
		const updatedVehicles = vehicles.map((v) => {
			if (v.id === activeCheckinShift.vehicleId) return {
				...v,
				status: "Available",
				assignedDriverId: void 0
			};
			return v;
		});
		setVehicles(updatedVehicles);
		...
		const hpUpdated = ERPStore.getHPContracts().map((contract) => {
			if (contract.driverId === activeCheckinShift.driverId) {
				...
				return {
					...
					status: meetsTarget ? "Active" : "Missed Remittance",
		...
		ERPStore.addAuditLog("Dispatcher", "Fleet Manager", "Shift Checkin", `Checked in shift ${activeCheckinShift.id}. Paid: ₦${checkinData.actualRemittance}. Status: ${finalStatus}.`);
		toast.success("Shift Closed Successfully", { description: `Remittance logged. Vehicle has been set back to Available status.` });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "font-display text-3xl font-bold text-foreground",
					children: "Shift operations dashboard"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm text-muted-foreground mt-1",
					children: "Dispatch vehicles to drivers, review checkouts, log daily evening remittance returns, and record mileage logs."
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					onClick: () => {
					...
					className: "inline-flex items-center gap-1.5 rounded-xl bg-forest px-4 py-2.5 text-xs font-semibold text-white hover:bg-forest-deep transition shadow-glow-soft cursor-pointer",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "h-4 w-4" }), "Morning checkout"]
				})]
			}),
			showCheckout && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				onSubmit: handleStartShift,
				className: "rounded-3xl border border-border bg-mist/20 p-6 space-y-4 animate-fade-down max-w-3xl",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
						className: "font-display font-bold text-base text-foreground flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserCheck, { className: "h-5 w-5 text-forest" }), "Dispatch Vehicle (Start Shift Checkout)"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "grid gap-4 sm:grid-cols-3",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
								...
								onChange: (e) => {
									drivers.find((d) => d.id === e.target.value);
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
								className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground block mb-1",
								children: "Select Available Tricycle / Vehicle"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
								required: true,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							type: "submit",
							className: "rounded-full bg-forest px-5 py-2 text-xs font-semibold text-white hover:bg-forest-deep transition cursor-pointer shadow-glow-soft",
							children: "Confirm Checkout & Release"
						})]
					})
				]
			}),
			activeCheckinShift && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				onSubmit: handleEndShiftSubmit,
				className: "rounded-3xl border border-emerald/30 bg-emerald-soft/10 p-6 space-y-4 animate-fade-down max-w-3xl",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
						className: "font-display font-bold text-base text-foreground flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheckBig, { className: "h-5 w-5 text-emerald" }), "Receive Vehicle & Record Remittance (Evening Shift Return)"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "p-4 rounded-2xl bg-white border border-border/80 text-xs space-y-1.5 mb-2",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["Shift ID: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-mono font-bold text-forest",
								children: activeCheckinShift.id
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["Driver: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-semibold text-foreground",
								children: drivers.find((d) => d.id === activeCheckinShift.driverId)?.name
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["Vehicle: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-semibold text-foreground",
								children: vehicles.find((v) => v.id === activeCheckinShift.vehicleId)?.plateNumber
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["Expected Daily Remittance: ", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "font-bold text-forest-deep",
								children: ["₦", activeCheckinShift.expectedRemittance.toLocaleString()]
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["Checkout Mileage: ", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "font-semibold",
								children: [activeCheckinShift.startMileage, " km"]
							})] })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
								className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground block mb-1",
								children: "Return Odometer Mileage (km)"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								type: "number",
								required: true,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
								className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground block mb-1",
								children: "Actual Remittance Cash Paid (₦)"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								type: "number",
								required: true,
								...
								onChange: (e) => setCheckinData((prev) => ({
									...prev,
									actualRemittance: Number(e.target.value)
								})),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
						className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground block mb-1",
						children: "Operational Notes / Issue logs"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
					className: "font-display font-bold text-base text-foreground",
					children: "Active Daily Shifts & Checkout Log"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-[11px] text-muted-foreground",
					children: "List of drivers currently dispatched or returned today."
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "overflow-x-auto border border-border/70 rounded-2xl",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
						className: "w-full text-left text-xs border-collapse",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
									className: "p-4 text-right",
									children: "Remittance Expected / Paid"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
									className: "p-4 text-center",
									children: "Status"
							...
							children: shifts.map((shift) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "p-4 font-semibold text-foreground",
											children: driverObj?.name || shift.driverId
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "p-4 font-mono text-foreground",
											children: vehicleObj?.plateNumber || shift.vehicleId
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "p-4 text-muted-foreground",
											children: shift.branch
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "p-4 font-semibold text-forest-deep",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
											...
											children: [
												shift.startMileage,
												" km → ",
												shift.endMileage ? `${shift.endMileage} km` : "ON ROAD",
												shift.endMileage && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
													className: "block text-[10px] text-muted-foreground",
													children: [
														"Travelled: ",
														shift.endMileage - shift.startMileage,
														" km"
													]
												})
											]
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: [
													shift.startTime,
													" ",
													shift.endTime ? ` - ${shift.endTime}` : "(Active)"
												]
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: ["Exp: ₦", shift.expectedRemittance.toLocaleString()]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "text-forest-deep",
												children: ["Paid: ₦", shift.actualRemittance ? shift.actualRemittance.toLocaleString() : "—"]
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "p-4 text-center",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: `inline-block rounded-full px-2.5 py-0.5 text-[9px] font-bold uppercase tracking-wider ${shift.status === "Completed" ? "bg-emerald-soft text-forest-deep" : shift.status === "Defaulted" ? "bg-red-100 text-red-500" : "bg-blue-100 text-blue-600 animate-pulse"}`,
												children: shift.status
											})
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "p-4 text-right",
											children: isOngoing ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												onClick: () => {
													...
													setCheckinData((prev) => ({
														...
														endMileage: shift.startMileage + 50
													}));
												},
...
function HirePurchase() {
	...
	const filtered = contracts.filter((c) => {
		const driver = ERPStore.getDrivers().find((d) => d.id === c.driverId);
		return c.id.toLowerCase().includes(search.toLowerCase()) || driver && driver.name.toLowerCase().includes(search.toLowerCase());
	});
		...
		children: [
			...
			showCalculator && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
						className: "font-display font-bold text-base text-foreground flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calculator, { className: "h-5 w-5 text-forest" }), "Hire Purchase Repayment Schedule Calculator"]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "grid gap-4 sm:grid-cols-2",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "grid gap-4 sm:grid-cols-3 pt-3 text-center",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									className: "font-display text-xl font-bold text-forest-deep mt-1",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: filtered.map((contract) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: `rounded-3xl border p-6 bg-white shadow-soft relative overflow-hidden transition-all duration-300 hover-lift ${isWarning ? "border-amber-300" : "border-border"}`,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-between border-b border-border/50 pb-4 mb-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
									...
									className: `inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-[9px] font-bold uppercase tracking-wider ${contract.status === "Active" ? "bg-emerald-soft text-forest-deep" : contract.status === "Completed" ? "bg-blue-100 text-blue-600" : "bg-red-100 text-red-500 animate-pulse"}`,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									className: "font-mono font-bold text-forest-deep",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex justify-between text-[11px] font-semibold text-charcoal",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "bg-mist/70 h-2.5 rounded-full overflow-hidden border border-border/50",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "pt-4 border-t border-border/50 flex items-center justify-between text-xs",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	const revenueSources = [
		{
			...
			value: transactions.filter((t) => t.type === "Revenue" && t.category === "CNG Conversion").reduce((sum, t) => sum + t.amount, 0)
		},
		{
			name: "Hire Purchase",
			value: transactions.filter((t) => t.type === "Revenue" && t.category === "Hire Purchase").reduce((sum, t) => sum + t.amount, 0)
		},
		{
			name: "Workshop Repairs",
			value: transactions.filter((t) => t.type === "Revenue" && t.category === "Workshop Repairs").reduce((sum, t) => sum + t.amount, 0)
		},
		{
			name: "Fleet Remittances",
			value: transactions.filter((t) => t.type === "Revenue" && (t.category === "Fleet Remittance" || t.category === "Other")).reduce((sum, t) => sum + t.amount, 0)
		}
...
function AdminPanel() {
	...
	const renderTabContent = () => {
		...
		switch (activeTab) {
			...
			case "drivers": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DriverManagement, {});
			case "fleet": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FleetManagement, {});
			case "shifts": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShiftManagement, {});
			case "hp": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HirePurchase, {});
			case "workshop": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WorkshopConversions, {});
			...
			case "crm": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CRM, {});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex min-h-screen bg-mist/20",
