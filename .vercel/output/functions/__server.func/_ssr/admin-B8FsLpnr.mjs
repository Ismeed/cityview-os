...
import { A as Phone, B as LayoutDashboard, C as ShieldAlert, Ct as Boxes, D as Save, E as Search, F as MapPin, H as Info, J as Fuel, L as LogOut, M as MonitorSmartphone, O as RefreshCw, Ot as ArrowRight, P as Menu, Q as FileDown, S as ShieldCheck, T as Send, Tt as Barcode, V as Key, W as History, X as FileSpreadsheet, Y as FileText, Z as FilePenLine, b as Sparkles, bt as Calculator, c as UserCheck, ct as Clipboard, d as TriangleAlert, dt as CircleCheckBig, et as Eye, f as TrendingUp, ft as CircleAlert, g as ToggleLeft, gt as Check, h as ToggleRight, ht as ChevronDown, i as Users, j as Moon, k as Plus, l as Upload, lt as ClipboardList, m as Trash2, mt as ChevronLeft, n as Wrench, nt as DollarSign, o as User, p as TrendingDown, pt as ChevronRight, q as Funnel, r as Wallet, rt as Database, s as UserPlus, st as Clock, t as X, tt as EyeOff, u as Truck, ut as CircleCheck, v as Sun, w as Settings, wt as Bell, x as Shield, xt as Building2, y as SquareUserRound, yt as Calendar } from "../_libs/lucide-react.mjs";
import { t as useTheme } from "./useTheme-DsmUlAKc.mjs";
import { t as ERPStore } from "./mockData-BCTNDn8F.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-B8FsLpnr.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: contracts.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "p-8 md:p-12 text-center max-w-2xl mx-auto space-y-6",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "h-16 w-16 rounded-full bg-emerald-500/10 text-emerald flex items-center justify-center mx-auto border border-emerald/20",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Wallet, { className: "h-8 w-8" })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "font-display text-xl font-bold text-foreground",
									children: "No Active Hire Purchase Leases"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm text-muted-foreground leading-relaxed",
									children: "Before you can record daily remittances, the platform requires active Hire Purchase contracts. Since the database has been cleared for your manual QA run, please follow these steps to set up your first lease:"
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "text-left bg-muted/40 border border-border p-5 rounded-2xl space-y-4",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex gap-3",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "h-6 w-6 rounded-full bg-emerald text-white text-xs font-bold flex items-center justify-center shrink-0",
											children: "1"
											...
											children: "Add a Driver"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-[11px] text-muted-foreground mt-0.5",
											children: "Go to the **Drivers** tab and register a new driver account."
										})] })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex gap-3 border-t border-border/60 pt-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "h-6 w-6 rounded-full bg-emerald text-white text-xs font-bold flex items-center justify-center shrink-0",
											children: "2"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h5", {
											...
											className: "text-[11px] text-muted-foreground mt-0.5",
											children: "Go to the **Fleet** tab and register a vehicle with status set to **\"Available\"**."
										})] })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex gap-3 border-t border-border/60 pt-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											className: "font-bold text-xs text-foreground",
											children: "Create Hire Purchase Contract"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-[11px] text-muted-foreground mt-0.5",
											children: "Go to the **Hire Purchase Ledger** tab, click **\"Assign New Lease\"**, select your driver and vehicle, and click create."
										})] })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex gap-3 border-t border-border/60 pt-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											className: "font-bold text-xs text-foreground",
											children: "Record Remittance"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-[11px] text-muted-foreground mt-0.5",
											children: "Return to this **Daily Remittances** board. You will now see the driver's name listed with a **\"Record Payment\"** button."
										})] })]
									})
								]
							})
						]
					}) : displayedItems.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function Settings$1({ currentUser }) {
	...
	const [passwordState, setPasswordState] = (0, import_react.useState)({
		currentPassword: "",
		newPassword: "",
		confirmPassword: ""
	});
	...
	const [revealPasswords, setRevealPasswords] = (0, import_react.useState)({});
	const [copiedEmail, setCopiedEmail] = (0, import_react.useState)(null);
	const [users, setUsers] = (0, import_react.useState)(() => ERPStore.getUsers());
	const [showAddUserModal, setShowAddUserModal] = (0, import_react.useState)(false);
	...
	const isAdmin = currentUser?.role === "Super Admin" || currentUser?.role === "Managing Director (CEO)" || currentUser?.role === "System Administrator" || currentUser?.role === "Executive Director";
	const handleChangePassword = (e) => {
		...
		setTimeout(() => {
			const updatedUsers = ERPStore.getUsers().map((u) => {
				if (u.email.toLowerCase() === currentUser.email.toLowerCase()) return {
					...u,
					passwordHash: passwordState.newPassword
				};
				return u;
			});
			...
			toast.success("Password Updated", { description: "Your login credentials password was changed successfully." });
			setPasswordState({
				currentPassword: "",
				newPassword: "",
				confirmPassword: ""
	...
	const handleCreateUser = (e) => {
		...
		toast.success("Account Created", { description: `User account for ${userEntry.name} registered with default password.` });
	...
	const handleToggleUserStatus = (email) => {
		...
		ERPStore.saveUsers(updatedUsers);
		setUsers(updatedUsers);
		toast.info("Account Privileges Updated", { description: "User account status toggled successfully." });
	};
	...
	const copyToClipboard = (email) => {
		...
		setTimeout(() => setCopiedEmail(null), 2e3);
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-8 animate-fade-in max-w-5xl text-foreground",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "border-b border-border pb-6 flex items-center justify-between",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "font-display text-3xl font-bold text-foreground",
					children: "Profile & Settings"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm text-muted-foreground mt-1",
					children: isAdmin ? "Manage system-wide corporate settings, register new staff accounts, and enable or disable access privileges." : "Update your login password and review your active branch operational privileges."
				})] })
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
							className: "font-display font-bold text-base text-foreground flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(User, { className: "h-5 w-5 text-emerald" }), "Active Account Profile"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "grid gap-4 sm:grid-cols-2 text-xs",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "p-3.5 rounded-2xl bg-muted/30 border border-border/50",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-[9px] uppercase tracking-wider text-muted-foreground block",
										children: "Full Name"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-semibold text-foreground text-sm",
										children: currentUser?.name || "System User"
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "p-3.5 rounded-2xl bg-muted/30 border border-border/50",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										className: "font-semibold text-foreground text-sm",
										children: currentUser?.role || "Staff"
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "p-3.5 rounded-2xl bg-muted/30 border border-border/50",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										className: "font-semibold text-foreground text-sm font-mono break-all",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										className: "font-semibold text-foreground text-sm",
										children: currentUser?.branchName || "—"
									})]
								})
							]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-3xl border border-border bg-card p-6 shadow-soft space-y-6",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
							className: "font-display font-bold text-base text-foreground flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Key, { className: "h-5 w-5 text-emerald" }), "Update Account Password"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										...
										children: showPass.current ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeOff, { className: "h-4 w-4" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, { className: "h-4 w-4" })
									})]
								})] }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "grid gap-4 sm:grid-cols-2",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
											...
											className: "absolute right-3.5 top-3 text-muted-foreground hover:text-foreground cursor-pointer",
											children: showPass.new ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeOff, { className: "h-4 w-4" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, { className: "h-4 w-4" })
										})]
									})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
										className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground block mb-1",
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
											...
											className: "absolute right-3.5 top-3 text-muted-foreground hover:text-foreground cursor-pointer",
											children: showPass.confirm ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeOff, { className: "h-4 w-4" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, { className: "h-4 w-4" })
										})]
									})] })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Key, { className: "h-4 w-4" }), passwordLoading ? "Saving..." : "Change Password"]
									})
								})
							]
						})]
					...
					className: "space-y-6",
					children: isAdmin ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-3xl border border-border bg-card p-6 shadow-soft space-y-4",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
								className: "font-display font-bold text-base text-foreground flex items-center gap-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Database, { className: "h-5 w-5 text-emerald" }), "Backup & Sync"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						className: "rounded-3xl border border-red-500/20 bg-red-500/5 p-6 shadow-soft space-y-4",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
								className: "font-display font-bold text-base text-red-500 flex items-center gap-2",
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
								className: "font-display font-bold text-sm text-foreground flex items-center gap-1.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shield, { className: "h-4.5 w-4.5 text-emerald" }), "Access Clearances"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-[11px] text-muted-foreground leading-relaxed",
								children: [
									...
									" is operating under hub security restrictions."
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "text-[10px] text-muted-foreground bg-muted/40 p-3 rounded-xl space-y-1",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "• System configurations locked" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "• Database backups restricted" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "• Enterprise credentials hidden" })
								]
							})
						]
					})
			...
			isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "rounded-3xl border border-border bg-card p-6 shadow-soft space-y-6",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex flex-col sm:flex-row sm:items-center justify-between border-b border-border pb-4 gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
						className: "font-display font-bold text-lg text-foreground flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shield, { className: "h-5 w-5 text-emerald" }), "User Account Management"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs text-muted-foreground mt-0.5",
						children: "Create new staff accounts, assign default passwords, and enable/disable system access."
					})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserPlus, { className: "h-4 w-4" }), "Register User Account"]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
							...
							children: users.map((user) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								className: `hover:bg-muted/10 transition ${user.disabled ? "bg-muted/20 opacity-70" : ""}`,
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "p-4 font-semibold text-foreground",
										children: user.name
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "p-4",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "inline-block rounded bg-muted px-2 py-0.5 text-[9px] font-bold text-muted-foreground uppercase",
											children: user.role
										})
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												title: "Copy Email",
												children: copiedEmail === user.email ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "h-3 w-3 text-emerald" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clipboard, { className: "h-3 w-3" })
											})]
										})
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center gap-2",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: revealPasswords[user.email] ? user.passwordHash : "••••••••" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												...
												children: revealPasswords[user.email] ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeOff, { className: "h-3 w-3" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eye, { className: "h-3 w-3" })
											})]
										})
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "p-4 text-center",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: `inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold ${user.disabled ? "bg-red-500/10 text-red-500" : "bg-emerald-500/10 text-emerald"}`,
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "flex items-center justify-end gap-2",
											children: user.email !== currentUser?.email && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												onClick: () => handleToggleUserStatus(user.email),
												className: "text-muted-foreground hover:text-emerald transition cursor-pointer p-1 rounded hover:bg-muted",
												title: user.disabled ? "Enable Account" : "Disable Account",
												children: user.disabled ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToggleLeft, { className: "h-4.5 w-4.5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToggleRight, { className: "h-4.5 w-4.5 text-emerald" })
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			showAddUserModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bg-card w-full max-w-md rounded-3xl border border-border p-6 shadow-2xl animate-scale-in space-y-4",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center justify-between border-b border-border pb-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
							className: "font-display font-bold text-lg text-foreground flex items-center gap-1.5",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserPlus, { className: "h-5 w-5 text-emerald" }), "Register Staff Account"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
function AdminPanel() {
	...
	const renderTabContent = () => {
		...
		switch (activeTab) {
			...
			case "settings": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Settings$1, { currentUser });
