...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DwC_HKOd.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-Dwb0WEas.css";
...
function Logo({ variant = "dark" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "relative flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-gradient shadow-glow",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
				...
				"aria-hidden": true,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12 2 4 6v6c0 5 3.5 8.5 8 10 4.5-1.5 8-5 8-10V6l-8-4Z" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "m9 12 2 2 4-4" })]
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			className: "flex flex-col leading-none",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: `font-display text-[15px] font-semibold tracking-tight ${text}`,
				children: "CityView CNG"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: `text-[10px] uppercase tracking-[0.18em] ${sub}`,
				children: "Automobile Synergy"
			})]
		})]
	});
}
